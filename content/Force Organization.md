Army lists must conform to the Battlegroup detachment configuration instead of the usual Combined Arms and other Formation detachments, as described below. An army composed this way gains the same benefits as if it were a Combined Arms detachment.
...
Front-line units may be taken in any quantity, following other limitations.

### HQ

For each HQ unit taken in your roster, you may include a single unit from Elites.
...
These are specialized units, and may only be taken in limited quantities. Single Elites, Heavy Support, and Fast Attack units may only be taken with a corresponding Front-line asset.

Other unit types may be taken per scenario, or as described below:

### Fortifications

Fortifications may only be taken as defined by the scenario. It is recommended to determine the scenario before lists are written to account for this.
### Lords of War
...
The following units (and wargear) are Restricted, unless stated otherwise:
